...
export class QuestionDetail extends React.Component {

  constructor(props){
    super(props)
    this.state = { likeCount: this.props.question.likes_count,
  ...
  updateQuestionCounter = (data) => {
    fetch(`http://[::1]:3000/api/v1/questions/${this.props.question.id}/update_counter`,{
      method: 'PUT',
      headers: {
  ...
  return (
          <div className='card rounded-0 mt-3' >
            <div className='card-body'>
              ...
              <button type='button' className='btn btn-primary position-relative'  onClick={this.
                updateLikeCounter} style={{marginRight: 1+'em'}}>
                Like
                {
                  this.state.likeCount > 0 ?
                  <span className='position-absolute top-0 star-100
